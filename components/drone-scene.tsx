  ...
  return (
    <div className="w-full h-full relative">
      ...
      <div className="absolute inset-0 z-5 pointer-events-none">
        {/* Overlay diferente según el tema */}
        {theme === 'light' && (
          <div className="absolute inset-0 bg-gradient-to-br from-blue-50/30 via-white/10 to-blue-100/20 z-1" />
        )}
      ...
      <iframe
        ...
        style={{ 
          filter: theme === 'light' 
            ? 'hue-rotate(240deg) saturate(1.1) brightness(1.2) contrast(1.1)' 
            : 'hue-rotate(240deg) saturate(1.3) brightness(0.8)',
    ...
    <div className={`w-full h-full relative overflow-hidden ${
      ...
      <div className="relative z-10 flex items-center justify-center h-full">
        <div className="text-center">
          ...
          <h1 className={`text-5xl md:text-6xl font-bold mb-4 bg-gradient-to-r from-blue-600 via-blue-700 to-blue-800 bg-clip-text text-transparent`}>
            Sky Solutions
          </h1>
