        ...
        <div className="max-w-4xl mx-auto">
          <div className="space-y-8">
            {aiFeatures.map((feature, index) => (
              <div
                key={index}
                className="group relative pl-8 pb-8 border-l-2 border-gray-200 dark:border-gray-700 last:border-l-0 last:pb-0"
              >
                {/* Punto en la línea */}
                ...
                {/* Contenido */}
                <div className="bg-white dark:bg-gray-800/50 rounded-lg p-6 shadow-sm border border-gray-200 dark:border-gray-700 hover:shadow-md transition-all duration-300 hover:-translate-y-1">
